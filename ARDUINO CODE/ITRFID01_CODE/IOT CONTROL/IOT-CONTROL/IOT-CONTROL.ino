...
#define AIO_USERNAME    "M0622"
#define AIO_KEY         "aio_kcSH80oZzILFjktmw9lgk9dI2WHD"
...
Adafruit_MQTT_Publish hb1 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/");
Adafruit_MQTT_Publish spo21 = Adafruit_MQTT_Publish(&mqtt, AIO_USERNAME "/feeds/");
...
void setup() {
  ...
  pinMode(D1, OUTPUT);
  digitalWrite(iot_pin, HIGH);
  pinMode(iot_pin, OUTPUT);
  delay(10);
